...
proj = '/THESIS/GSE182270/'
dir_raws = 'FW_GSE182270_raws/'
dir_res_plots = 'plots/'
dir_res_h5ad = 'h5ad/'
raw_file_suffix = '.zip'
...
#==========================================
# STEP 03: Check the current directory path
#==========================================
import os
...
zip_path = "GSE182270_RAW.zip"
output_dir = "FW_GSE182270_raws_1"
...
#==========================================
# STEP 05: Defining Sample Metadata
#==========================================

metadata_path = "sample_metadata_1.csv"
...
#======================================================================
# STEP 06: Loading 10X matrices and building Anndata objects per sample
#======================================================================
import os

adatas = []
sample_root = os.path.join(output_dir, "GSE182270_RAW")
...
#======================================================================
# STEP 07: Check sample and group metadata in one sample
#======================================================================
...
#===========================================
# STEP 08: Summarize sample counts per group
#===========================================
...
output_dir = "GSE182270_preprocessed_1/h5ad_preprocessed"
...
with open("adata_3rd_preprocessed.pkl", "wb") as f:
...
#This was done as a sbatch with mad_outlier_filter_1.py in mad_filter_1_job.sh
# Details are in mad_outlier_filter_1.py and mad_filter_1_job.sh
...
# ========== Load adata_lst ==========
with open("adata_3rd_preprocessed.pkl", "rb") as f:
...
meta_df = pd.read_csv("sample_metadata_1.csv")  # adjust path if needed
...
#Note: Adaptive thresholds are used to remove the bais of having one threshold of 0.2 or 0.25 whihc will not give correct outputs.
#This was done as a batch with scrublet_removal_1 in doublet_scrublet.sh
#Details are in scrublet_removal_1.py and doublet_scrublet.sh

# Path to filtered .h5ad files
# Path to filtered .h5ad files
input_dir = "filtered_2_h5ad"
out_dir = "filtered_2_h5ad_scrublet"
metadata_csv = "sample_metadata_1.csv"  # Must have columns: GSM_ID, Sample_ID
...
#===============================================
# STEP 11: HVG Filtering
#===============================================

# this run as a sbatch with run_hvg_filtering.py 
...
#2.Scale and regress out confounders
import scanpy as sc
...
meta_df = pd.read_csv("sample_metadata_1.csv")  # Ensure this has GSM_ID and Group
...
# PCA, UMAP, and Leiden clustering run as a sbatch
...
# ========= 8. Generate expression matrix CSV =========
import pandas as pd
...
# Save pre-integration log-normalized data as .raw
import scanpy as sc
...
markers_df.to_csv("results/scanorama_leiden_markers_1.csv", index=False)
...
sc.pl.rank_genes_groups(
    ...
    save="_scanorama_leiden_top20_1.png"
)

print("✅ Marker gene detection complete: results/scanorama_leiden_markers_1.csv + top20_1 plot saved")
...
markers_group_df.to_csv("results/condition_DEGs_by_Group_1.csv", index=False)
